	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    input_info.setOnClickListener(new OnClickListener() {
	    	...
	    	public void onClick(View v)	{
	    		...
	    		if(blinder_name.getText().toString().length() != 3 ||
	    				protecter_name.getText().toString().length() != 3 ||
	    				protecter_pn.getText().toString().length() != 11)
	    		{
	    			//Toast.makeText(this,"hi" , Toast.LENGTH_LONG);
	    			Toast.makeText(Informationproc.this, "이름은 3글자, 전화번호는 11글자 숫자로 입력하세요", Toast.LENGTH_LONG).show();
	    		}
	    		else
	    		{
